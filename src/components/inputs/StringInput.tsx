...
export default function StringInput(props: StringInputProps) {
  ...
  return (
    <textarea
      className="focus:shadow-outline w-full appearance-none break-words break-all rounded border leading-tight text-dark-gray-700 shadow focus:outline-none dark:bg-dark-gray-350 dark:text-white"
