...
export default function StringInput(props: StringInputProps) {
  ...
  return (
    <textarea
      className="focus:shadow-outline w-full appearance-none break-words break-all rounded border leading-tight text-black-700 shadow focus:outline-none dark:bg-gray-1200 dark:text-white"
