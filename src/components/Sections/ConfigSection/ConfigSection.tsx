...
export function ConfigSection() {
  ...
  return (
    <div className="mb-4 flex flex-col justify-center rounded bg-white shadow-md dark:bg-dark-gray-300 gap-2 p-2">
      <Button
      ...
      <label className="mx-2 flex cursor-pointer flex-row justify-center rounded bg-dark-gray-250 py-2 text-center font-bold text-white shadow-sm hover:bg-dark-gray-300">
