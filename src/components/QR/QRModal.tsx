  ...
  return (
    <>
      {props.show && (
        <>
          <div
            className="fixed inset-0 h-full w-full overflow-y-auto bg-black-300 bg-opacity-50 dark:bg-opacity-70 backdrop-blur-sm "
            id="my-modal"
          />
          <div
            ref={modalRef}
          ...
          >
            <div className="flex flex-col items-center pt-8 ">
              ...
              <h1 className="text-3xl text-black-800 font-rhr-ns ">{title}</h1>
